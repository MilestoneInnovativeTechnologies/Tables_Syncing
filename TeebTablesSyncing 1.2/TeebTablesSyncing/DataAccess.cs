    ...
    public class DataAccess
    {
       ...
       */
        ...
        */
        ...
        public void PostJson(List<ItemMasterInfo> Data)
        {
            try
            {
                ...
                File.Delete(@"C:\Table_sys\Data_file.json");
                System.IO.File.WriteAllText(@"C:\Table_sys\Data_file.json", json);

                using (WebClient client = new WebClient())
                {
                    client.UploadFile("http://demopd.milestoneit.online/interact", @"C:\Table_sys\Data_file.json");
                }
                ...
                //System.IO.File.WriteAllText(@"C:\Users\Vishnu gopi\Desktop\Proj Tst\tst.json", Data);
                //string FileName = File.ReadAllText(Data.ToString());
                //string FileName = new JavaScriptSerializer().Serialize(Json);
                //var wc = new WebClientEx();
                //wc.Headers[HttpRequestHeader.ContentType] = json;
                //wc.Timeout = 9000000;
                //wc.Encoding = Encoding.UTF8;
                //var BaseAddress = "http://demopd.milestoneit.online/interact";
                //string response = wc.UploadString(BaseAddress, json);
